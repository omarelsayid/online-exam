  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: buildCustomAppBar(
        title: examResult['examTitle'] ?? 'Exam Details', isVisible: true,context: context),
                ...
                ...answers.map((ans) {
                  ...
                  return Padding(
                    ...
                    child: RadioListTile<String>(
                      ...
                      title: Text(ansText,  style: AppTextStyles.inter500_18.copyWith(color: Color(0xFF0E0E0E),fontSize: 14),),
                    ),
                  );
                }).toList(),
              ],
